...
def AddSection(root, existingref):
    def write_section(root):
        ...
        for selected in inclistbox.curselection():
            incselection[inclistbox.get(
                selected)] = "upcount"  # --------------add ability to select whether upcount or downcount increments
        for selected in declistbox.curselection():
            decselection[declistbox.get(selected)] = "upcount"  # ----------------ditto above decrements
    ...
    inclistbox.bind("<Button-3>", right_click_menu

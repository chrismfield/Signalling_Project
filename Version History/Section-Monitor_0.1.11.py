...
def Add_route(root,existingref):
    ...
    def choose_aspects():
        ...
        ttk.Button(aspectsetupwin, text="OK", command=lambda: aspectsetupwin.destroy()).grid(column=4, row=11, sticky=E)#-------need to use this save variables to signal

      #figure out how to store them checkbox selections sensibly and restore them to edit. Then apply to signal setup with input boxes for addresses.
      #perhaps store aspects as a list inside a list container with the name of the signal?
